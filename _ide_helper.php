 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::jsonSuccess($message, $data);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function jsonError($message, $data = [])
        {
                        return \Illuminate\Routing\ResponseFactory::jsonError($message, $data);
        }
